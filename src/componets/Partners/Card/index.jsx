function Card() {
    return (
        <>
            <div className="bg-gray-dark rounded-2xl py-5 flex flex-col items-center justify-center shadow-lg border border-gray-dark m-5">
                ...
                <p className="font-bold mt-4 text-white">Zapier</p>
